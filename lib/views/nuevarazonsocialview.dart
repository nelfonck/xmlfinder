...
class NuevaRazonSocialView extends StatelessWidget {
  const NuevaRazonSocialView({super.key, this.modificar, this.razonSocial});
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: ModelReady(
        onModelReady: (NuevaRazonSocialViewModel model)async{
          if (modificar!=null){
            if (modificar!){
              model.init(razonSocial);
            }
          }
        },
                    ...
                    onPressed: ()async{
                      try {
                        if (modificar==null){
                          ...
                          final result = await model.modificarRazonSocial();
                    ...
                    Row(
                      children: [
                        ...
                        DropdownMenu<String>(
                          ...
                          initialSelection: model.tipoSeleccionado,
